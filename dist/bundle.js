...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../type-write/dist/type-write.js */ \"../type-write/dist/type-write.js\");\n/* harmony import */ var _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0__);\n\n\ndocument.addEventListener('DOMContentLoaded', () => {\n\n  // ABOUT SECTION\n\n  const about1 = document.querySelector('.about1')\n  const about2 = document.querySelector('.about2')\n  const about3 = document.querySelector('.about3')\n  const about4 = document.querySelector('.about4')\n\n  const aboutTw1 = new _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default.a(about1)\n  const aboutTw2 = new _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default.a(about2)\n  const aboutTw3 = new _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default.a(about3)\n  const aboutTw4 = new _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default.a(about4)\n\n  const clearAll = () => {\n    aboutTw1.clearText()\n    aboutTw2.clearText()\n    aboutTw3.clearText()\n    aboutTw4.clearText()\n\n    aboutTw1.start()\n  }\n\n  aboutTw1\n    .type('Fast')\n    .removeCursor()\n    .rest(300)\n    .then(aboutTw2.start.bind(aboutTw2))\n    .start()\n\n  aboutTw2\n    .type('Easy to use')\n    .removeCursor()\n    .rest(300)\n    .then(aboutTw3.start.bind(aboutTw3))\n\n  aboutTw3\n    .type('Fully-featured')\n    .removeCursor()\n    .rest(300)\n    .then(aboutTw4.start.bind(aboutTw4))\n\n  aboutTw4\n    .type('Dependency-free')\n    .removeCursor()\n    .rest(2000)\n    .then(clearAll)\n\n  // DEMO 1\n\n  const test1 = document.querySelector('.test1')\n\n  const testTw1 = new _type_write_dist_type_write_js__WEBPACK_IMPORTED_MODULE_0___default.a(test1, {\n    loop: true,\n    typeSpeed: 80,\n    deleteSpeed: 80,\n    typeColor: 'red'\n  })\n\n  testTw1\n    .type('You can type')\n    .rest(500)\n    .changeOps({ deleteSpeed: 80 })\n    .remove(4)\n    .type('edit')\n    .rest(500)\n    .remove(4)\n    .type('synchronize callbacks')\n    .rest(500)\n    .changeOps({ deleteSpeed: 20 })\n    .remove(21)\n    .type('change options on the go')\n    .rest(500)\n    .clear()\n    .start()\n})\n\n//# sourceURL=webpack:///./js/main.js?");
